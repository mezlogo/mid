...
public class NettyHttpTunnelServer extends HttpTunnelServer {
    ...
    public static NettyHttpTunnelServer createHttpTunnelServer() {
        var group = new NioEventLoopGroup();
        var bootstrap = createServer(tunnelInitializer(), group);
        return new NettyHttpTunnelServer(bootstrap);
    }
