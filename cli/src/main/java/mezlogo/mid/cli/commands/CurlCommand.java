...
import mezlogo.mid.core.netty.NettyHttpClient;
...
public class CurlCommand implements Runnable {
    ...
    public void run() {
        ...
        client.start().join();
        BodyPublisher reqBody = Publishers.fromList(null != data ? Arrays.asList(data) : Collections.emptyList());
